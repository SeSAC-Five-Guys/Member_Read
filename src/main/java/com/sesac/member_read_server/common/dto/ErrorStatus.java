...
public enum ErrorStatus {
	...
	DUPLICATE_EMAIL(409, "Member-00", "이미 존재하는 Email 입니다."),
	DUPLICATE_NICKNAME(409, "Member-00", "이미 존재하는 NickName 입니다."),
	DUPLICATE_PHONENUMBER(409, "Member-00", "이미 존재하는 핸드폰 번호 입니다."),
	INVALID_INPUT_PW(400, "Member-00", "비밀번호에 영문, 숫자, 특수문자가 모두 포함시켜야 하고 8~16자리를 입력해야 합니다, 공백은 입력이 불가능 합니다."),
	INVALID_INPUT_NICKNAME(400, "Member-00", "닉네임이 특수문자나 공백을 포함할 수 없으며, 2~10자리 까지 입력할 수 있습니다."),
